...
<body>
    <!-- Inline JavaScript -->
    <button onclick="alert('นายวุฒิชัย จันทร์เดชะ')">ชื่อนักศึกษา</button>
...
```
![image](https://github.com/user-attachments/assets/ba8a4b4a-7d1c-4d4d-994b-72d07544edee)
...
```
![image](https://github.com/user-attachments/assets/cbc3efbf-299e-4de5-b207-a460eee0694d)
...
const greetUser = (name, age) => {
    return age < 13 ? `ไงพี่ ${name}` :
           age < 20 ? `Hello ${name}` :
                      `HI ${name}`;
};

// ทดสอบใช้งาน
console.log(greetUser("โดเรม่อน", 10));
console.log(greetUser("ชิสุกะ", 18));
console.log(greetUser("ดอเรีย", 25));
...
```
![image](https://github.com/user-attachments/assets/65b04f06-984d-4175-bc1d-e29381b75e31)
    ...
    <form id="bookingForm">
        ...
        <div>
            ...
            <select id="roomtype" name="roomtype" required onchange="updatePrice()">
                <option value="">กรุณาเลือกประเภทห้องพัก</option>
                // ผมเพิ่มให้โปรแกรมแสดงราคาห้องของห้องแต่ละระดับ
                <option value="standard" data-price="6,900">ห้องมาตรฐาน (6,900 บาท/คืน)</option>  
                <option value="deluxe" data-price="7,200">ห้องดีลักซ์ (7,200 บาท/คืน)</option>
                <option value="suite" data-price="12,900">ห้องสวีท (12,900 บาท/คืน)</option>
            </select>
        </div>
...
```
![image](https://github.com/user-attachments/assets/13f5969e-9401-49ab-8b63-58e77a8e05ae)
